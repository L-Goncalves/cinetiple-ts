...
export const LatestNews = () => {
  ...
  <div className="news">
    ...
    <div className='news_container'>
        <NewsContent title={'21 Savage e Metro Boomin lançam o álbum “Savage Mode 2”'}/>
        <NewsContent title={'Wavves anuncia novo álbum, Hideaway'}/>
        <NewsContent title={'The Weeknd quebra novo recorde na Billboard em parceria com Ariana Grande'}/>
        <NewsContent title={'21 Savage e Metro Boomin lançam o álbum “Savage Mode 2”'}/>
        <NewsContent title={'Wavves anuncia novo álbum, Hideaway'}/>
        <NewsContent title={'The Weeknd quebra novo recorde na Billboard em parceria com Ariana Grande'}/>
    </div>
